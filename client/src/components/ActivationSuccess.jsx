              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <div className="flex flex-col items-center gap-4 justify-center">
                  <p className="text-gray-700 text-center leading-relaxed text-sm md:text-base max-w-[90%]">
                    Sie haben Ihr Konto erfolgreich verifiziert. Melden Sie sich
                    mit den Zugangsdaten an, die Sie von Ihrer IT-Abteilung
                    erhalten haben.
                  </p>
                  ...
                  <NavLink
                    to={"/"}
                    className={
                      "text-center tracking-wide bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 mt-2 md:p-2 text-white uppercase w-1/2 rounded cursor-pointer hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
                    }
                  >
                    Zum Login
                  </NavLink>
