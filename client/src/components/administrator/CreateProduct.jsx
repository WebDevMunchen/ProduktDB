...
export default function CreateProduct() {
  ...
  const {
    ...
    defaultValues: {
      image: "https://res.cloudinary.com/dtrymbvrp/image/upload/",
                      ...
                      return (
                        ...
                        >
                          ...
                          {relatedProductPreview?._id === id && (
                            <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-white border rounded-lg shadow-lg p-2 w-48 z-50">
                              <p className="text-sm text-center mb-2 font-medium mt-1">
                                {relatedProductPreview.title}
                              </p>
                              <img
                                src={relatedProductPreview.image}
